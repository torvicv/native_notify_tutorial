  ...
  return (
    <>
      ...
      <aside
        ref={mySidebar}
        id="default-sidebar"
        className="fixed top-0 !transition-[left] duration-[1000ms] left-[-100%] z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <button className="bg-slate-900 py-2 px-4 text-white rounded-full" onClick={open}>
            X
        </button>
